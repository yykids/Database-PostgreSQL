...
Before using PostgreSQL, you need to create an instance first.

![postgresql_guide_ko_01_20201218.png](https://static.toastoven.net/prod_postgresql/postgresql_guide_ko_01_20201218.png)

Clicking the **Create PostgreSQL Instance** button moves you to **Compute > Instance > Create Instance**.

The four different PostgreSQL versions are provided:
...
Select a PostgreSQL version, complete the additional settings, and then create an instance. For more information on instance creation, see [Instance Overview](http://docs.toast.com/ko/Compute/Instance/ko/overview/).
